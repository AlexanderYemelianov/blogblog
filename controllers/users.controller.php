...
class UsersController extends Controller{
    ...
    public function registration(){
        if(isset($_POST['enter'])){
            if (isset($_POST['login']) && isset($_POST['password']) && isset($_POST['email']) && $_POST['password'] && $_POST['password_confirmation']){
                if($_POST['password'] == $_POST['password_confirmation']){
                    ...
                    Session::setFlash('Entered passwords is not identical.');
                }
            }else{
